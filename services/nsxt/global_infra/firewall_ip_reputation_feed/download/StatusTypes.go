...
func StatusGetOutputType() vapiBindings_.BindingType {
	return vapiBindings_.NewReferenceType(nsx_policyModel.IPReputationFeedDownloadStatusBindingType)
}
...
func statusGetRestMetadata() vapiProtocol_.OperationRestMetadata {
	...
	return vapiProtocol_.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/firewall-ip-reputation-feed/download/status",
		"",
		resultHeaders,
		200,
		"",
