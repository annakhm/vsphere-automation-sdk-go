...
type BlockedEventsClient interface {
	...
	Get(orgIdParam string, projectIdParam string, countryCodeParam *string, cursorParam *string, directionParam *string, includeAllProjectsParam *bool, ipAddressParam *string, pageSizeParam *int64, ruleIdParam *string) (nsx_policyModel.GeoIpBlockedEventsList, error)
}
...
func (bIface *blockedEventsClient) Get(orgIdParam string, projectIdParam string, countryCodeParam *string, cursorParam *string, directionParam *string, includeAllProjectsParam *bool, ipAddressParam *string, pageSizeParam *int64, ruleIdParam *string) (nsx_policyModel.GeoIpBlockedEventsList, error) {
